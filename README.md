...
- ✅ Выбор платежного приложения (с логотипом)
- ✅ PDF чек (демо)
- ✅ Генерация QR-кода
- ✅ Ручная запись ИПС / заметки
- ✅ Формат PDF готов к отправке
...
- ✅ Payment app selection (with logo)
- ✅ PDF receipt (demo)
- ✅ QR code generation
- ✅ Manual note / IPS
